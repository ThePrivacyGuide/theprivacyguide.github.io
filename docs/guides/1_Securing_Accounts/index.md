...
![Image showing the creation of a new account on Bitwarden. Please don't copy my password :smirk:](docs/guides/1_Securing_Accounts/images/image_1.png){: align=left }
...
![Your Vault the first time you start the application should look something like this. Click on Add item to add a new Password](docs/guides/1_Securing_Accounts/images/image_2.png){: align=left }
...
![Autofill with Bitwarden on Iphone](docs/guides/1_Securing_Accounts/images/image_5.png){: align=left }
