...
![Image showing the creation of a new account on Bitwarden. Please don't copy my password :smirk:](./resources/1_securing_accounts/image_1.png)
...
![Your Vault the first time you start the application should look something like this. Click on Add item to add a new Password](./resources/1_securing_accounts/image_2.png)

![Type in the Name of the Service, your email/username you use for this account and click on the arrows to generate a new random password](./resources/1_securing_accounts/image_3.png)

![Toggle the types of characters you want your password to contain. I always toggle all four and set the length to 25 characters](./resources/1_securing_accounts/image_4.png)
